...
/**
 * select table column controller
 * <pre>
 ...
 *
 * @author redli
 * @version 1.0.0 2019-05-15 17:23
 * @since 1.0.0
 */
    ...
    public void ok() {
        ...
        if (items != null && items.size() > 0) {
            ...
            items.forEach(item -> {
                ...
                } else if (item.getTypeHandle() != null || item.getJavaType() != null || item
                        .getPropertyName() != null) { // unchecked and have typeHandler value
