...
/**
 * picture process state controller
 * <pre>
 ...
 *
 * @author redli
 * @version 1.0.0 2019-05-15 16:31
 * @since 1.0.0
 */
public class PictureProgressStateController {
    private ImageView dbImage = new ImageView("icons/SSH_tunnel.png");
    private final Rectangle rectangle = new Rectangle(20, 20, 30, 30);
    ...
    public void startPlay() {
        ...
        rectangle.setFill(DARKSEAGREEN);
        ...
        vBoxRect.getChildren().add(rectangle);
        VBox.setMargin(rectangle, new Insets(125, 0, 0, 350));
    ...
    public void playerFailState(String message, boolean showButton) {
